...
public class AddGlucoseActivity extends AppCompatActivity {
    ...
    EditText Glucose, Date, Time, Food, Other_Info;
    Button addButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glucose = findViewById(R.id.glucose_input);
    ...
    private void addMeasurement(){
        final String GlucoseString = Glucose.getText().toString().trim();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Constants.URL_ADD_GLUCOSE, new Response.Listener<String>() {
            @Override
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("glucose", GlucoseString);
