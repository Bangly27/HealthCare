...
public class Constants {
    ...
    public static final String URL_ADD_GLUCOSE = ROOT_URL + "addGlucose.php";
    ...
    public static final String URL_GET_GLUCOSE = ROOT_URL + "getMeasurementGlucose.php";
    public static final String URL_WEIGHT_TEST = ROOT_URL + "test.php";
}
